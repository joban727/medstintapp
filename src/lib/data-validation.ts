...
export class DataIntegrityValidator {
  ...
  static validateRangeConstraints(data: any, constraints: Record<string, { min?: number; max?: number }>): string[] {
...
export class ValidationService {
  static validateUserInput(data: any): { isValid: boolean; errors: string[]; sanitizedData?: any } {
    ...
    const missingFields = DataIntegrityValidator.validateRequiredFields(sanitizedData, requiredFields)
  ...
  static validateTimeRecordInput(data: any): { isValid: boolean; errors: string[]; sanitizedData?: any } {
    const errors: string[] = []
  ...
  static validateApiRequest(data: any, schema: z.ZodSchema): { isValid: boolean; errors: string[]; sanitizedData?: any } {
