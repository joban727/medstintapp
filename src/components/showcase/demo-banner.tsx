...
export function DemoBanner() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 transform px-4 w-full max-w-3xl">
      <Card className="flex items-center justify-between gap-4 py-4 px-6 shadow-2xl border-primary/20 bg-background/60 backdrop-blur-xl rounded-xl border-white/10 bg-white/5">
