...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-xl border-2 border-border bg-surface-1 px-4 py-3 text-base ring-2 ring-transparent ring-offset-2 ring-offset-background transition-all duration-200 placeholder:text-text-muted focus-visible:border-medical-blue focus-visible:ring-medical-blue-light focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 hover:border-medical-blue/50",
      className
    )}
    {...props}
  >
