  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-theme-gradient text-white hover:bg-theme-gradient hover:text-white focus:bg-theme-gradient focus:text-white",
        day_today: "bg-white/10 text-white",
        day_outside:
          "day-outside text-[var(--text-muted)] opacity-50 aria-selected:bg-white/5 aria-selected:text-[var(--text-muted)] aria-selected:opacity-30",
