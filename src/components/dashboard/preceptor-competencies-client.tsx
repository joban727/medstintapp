...
export function PreceptorCompetenciesClient({
  ...
  const handleDetailedEvaluationClick = (competency: StudentCompetency) => {
    ...
    const assignment = {
      ...
      dueDate: competency.dueDate
        ? new Date(competency.dueDate).toISOString()
                ...
                <div key={student.studentId} className="rounded-lg border p-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {student.completedCount} / {student.totalCount || "—"} competencies
                          completed
                        </p>
                      </div>
                    </div>
                  ...
                  {student.competencies.length > 0 ? (
                        ...
                        {student.competencies.slice(0, 5).map((comp) => (
                          <TableRow key={comp.competencyId}>
                            ...
                            <TableCell>
                              <Badge
                                className={
                                  LEVEL_COLORS[comp.competencyLevel] ||
                            ...
                            <TableCell>
                              <Badge
                                className={
                                  STATUS_COLORS[comp.status] || "bg-gray-100 dark:bg-gray-800"
                                }
                              >
                    ...
                    <div className="py-4 text-center text-muted-foreground text-sm">
                      No competency assignments yet. Use "Sign Off" to record completed
                      competencies.
                    </div>
                  )}
