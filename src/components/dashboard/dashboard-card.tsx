...
export function DashboardCard({
    ...
    return (
        <Card className={cn(className)}>
            <CardHeader
                className={cn(
                    "flex items-center justify-between gap-0 pb-2",
                    collapsible &&
                    "cursor-pointer hover:bg-muted/50 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                )}
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    ...
                    {collapsible && (
                        ...
                        >
                            <ChevronRight
                                className={cn("h-3 w-3 sm:h-4 sm:w-4", isCollapsed ? "rotate-0" : "rotate-90")}
                                aria-hidden="true"
                            />
                        </Button>
                    )}
            ...
            {!isCollapsed && (
                <CardContent className="pt-0">
                    {loading && (
                        <div className="gap-3" aria-label="Loading content">
                    ...
                    {showEmptyState && (
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            {emptyState.icon && (
                                <emptyState.icon className="mb-6 h-16 w-16 text-muted-foreground" />
                            )}
                            <h3 className="mb-2 font-semibold text-primary text-base">{emptyState.title}</h3>
                            <p className="mb-6 text-muted-foreground text-sm">{emptyState.description}</p>
                            {emptyState.action && (
            ...
            <Card className={className}>
                <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <LoadingSkeleton height="h-4 w-4" className="rounded-md" />
                    </div>
                    <div className="mt-2">
                ...
                <div className="mt-2">
                    ...
                    {change && (
                        <div
                            className={cn(
                                "text-xs",
                                trend === "up" && "text-healthcare-green",
                ...
                <div className="mt-2">
                    ...
                    <div className="mt-2">
                        <div className="h-2 w-full rounded-full bg-muted">
                            <div
                                className="h-2 rounded-full bg-primary animate-progress-fill"
