...
export function ActionCenter({
  ...
  return (
    <Card
      className={cn(
        "h-full flex flex-col overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-sm",
        isProminent &&
          "bg-gradient-to-br from-slate-900/95 via-indigo-950/90 to-slate-900/95 border-indigo-500/30 shadow-2xl shadow-indigo-500/10"
      )}
    >
      {/* Header */}
