...
interface TimeTrackerProps {
  ...
  todayTimeRecord?: TimeRecord | null
  onTimeRecordUpdate?: (updatedRecord: TimeRecord) => void
}
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.timeRecord) {
          setOptimisticRecord(result.timeRecord as unknown as TimeRecord)
  ...
  const handleUpdateRecord = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.timeRecord) {
          setOptimisticRecord(result.timeRecord as unknown as TimeRecord)
          onTimeRecordUpdate?.(result.timeRecord as unknown as TimeRecord)
        }
      } else {
        // Revert optimistic update on error
        setOptimisticRecord(activeRecord)
