    ...
    <div className={`min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300 ${className}`}>
      <div className="flex flex-col items-center justify-center min-h-screen p-8">
        ...
        <div className="text-center">
          <div className={`${sizeClasses[size]} font-light text-gray-900 dark:text-white transition-colors duration-300 tracking-tight`}>
            {timeString}
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <div className="text-lg md:text-xl text-gray-600 dark:text-gray-300 transition-colors duration-300 font-light">
            {dateString}
          </div>
        </div>
        ...
        {/* Subtle separator */}
        <div className="mt-8">
          <div className="w-16 h-px bg-gray-300 dark:bg-gray-600 transition-colors duration-300" />
        </div>
      </div>
    </div>
  )
