...
import { cohortRotationAssignments, rotationTemplates, cohorts, programs, clinicalSites, users } from "@/database/schema"
    ...
    if (!schoolId) {
        return (
            <CohortRotationsClient
                ...
                templates={[]}
                clinicalSites={[]}
                stats={{ totalAssignments: 0, draftAssignments: 0, publishedAssignments: 0, completedAssignments: 0 }}
                schoolId=""
            />
        )
    }
