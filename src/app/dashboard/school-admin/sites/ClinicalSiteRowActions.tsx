  ...
  return (
    <>
      <DropdownMenu>
        ...
        >
          <DropdownMenuItem className="cursor-pointer focus:bg-primary/10" onClick={handleEdit}>
            Edit
          </DropdownMenuItem>
          <DropdownMenuItem className="cursor-pointer focus:bg-primary/10">View</DropdownMenuItem>
