...
export const PUT = withErrorHandling(async (request: NextRequest) => {
  ...
  if (validatedData.defaultDurationWeeks !== undefined)
    updateData.defaultDurationWeeks = validatedData.defaultDurationWeeks
  if (validatedData.defaultRequiredHours !== undefined)
    updateData.defaultRequiredHours = validatedData.defaultRequiredHours
  if (validatedData.defaultClinicalSiteId !== undefined)
    updateData.defaultClinicalSiteId = validatedData.defaultClinicalSiteId
